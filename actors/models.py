...
NATIONALITY_CHOICES = (
    ...
    ('BWA', 'Botsuana'),
    ('BRA', 'Brasil'), # Este já estava na sua lista!
    ...
    ('SVN', 'Eslovênia'),
    ('ESP', 'Espanha'),
    ('USA', 'Estados Unidos'), # Este também já estava!
    ('EST', 'Estônia'),
    ('ETH', 'Etiópia'),
    ('FJI', 'Fiji'),
    ('FIN', 'Finlândia'),
    ...
    ('KWT', 'Kuwait'),
    ('KGZ', 'Quirguistão'),
    ('LAO', 'República Democrática Popular do Laos'),
    ('LVA', 'Letônia'),
    ('LBN', 'Líbano'),
    ('LSO', 'Lesoto'),
    ('LBR', 'Libéria'),
    ...
    ('SCT', 'Escócia'), # Geralmente incluída como parte do Reino Unido, mas útil para algumas classificações.
    ('SLB', 'Ilhas Salomão'),
    ('SOM', 'Somália'),
    ('ZAF', 'África do Sul'),
    ('SSD', 'Sudão do Sul'),
    ...
    ('TWN', 'Taiwan (Província da China)'),
    ('TJK', 'Tajiquistão'),
    ('TZA', 'Tanzânia (República Unida da)'),
    ('THA', 'Tailândia'),
    ('TLS', 'Timor-Leste'),
    ('TGO', 'Togo'),
    ('TKL', 'Tokelau'),
    ...
    ('UZB', 'Uzbequistão'),
    ('VUT', 'Vanuatu'),
    ('VEN', 'Venezuela (República Bolivariana da)'),
    ('VNM', 'Vietnã'),
